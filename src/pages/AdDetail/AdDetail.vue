<template lang="html">
  <div class="song-wrapper">
    <div class="songs-bg" v-if="song.al" :style="{backgroundImage:'url('+ song.al.picUrl +')'}"></div>
    <div class="logo">
    ...
    <div class="song-roll">
      <div class="roll-bg">
        <img class="song-pic" :src="song.al.picUrl" alt="img"/>
      </div>
    </div>
    <div class="btn-group">
      <div class="open-btn">
...
export default {
  ...
  methods: {
    _getDetail () {
      ...
      axios.get(`/api/song/detail?ids=${id}`)
        .then(res => {
...
.roll-bg{
  background: url('https://s3.music.126.net/mobile-new/img/disc-ip6.png?69796123ad7cfe95781ea38aac8f2d48=') no-repeat;
